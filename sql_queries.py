...
CREATE TABLE IF NOT EXISTS songplays    (songplay_id SERIAL   PRIMARY KEY,
                                         ...
                                         , session_id int,location text , user_agent varchar
);
""")
...
#insert into songplays (   start_time, user_id, level, song_id, artist_id, session_id, location, user_agent)  VALUES (%s, #%s, %s, %s, %s, %s, %s) ;
...
do update set artist_location=excluded.artist_location,artist_latitude=excluded.artist_latitude ,artist_longitude = excluded.artist_longitude  ;  
